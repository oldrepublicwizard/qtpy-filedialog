...
from qtpy_filedialog._win32_stubs import COMDLG_FILTERSPEC, IShellItem
...
try:
    ...
    from qtpy_filedialog._win32_stubs import S_OK
    from qtpy_filedialog._win32_stubs import (
        COMDLG_FILTERSPEC,
        SIGDN,
        IFileOpenDialog,
        IFileSaveDialog,
    ...
    from qtpy_filedialog._win32_stubs import FileDialogControlEvents
