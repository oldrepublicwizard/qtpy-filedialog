...
from qtpy_filedialog.adapters.filesystem.qtimezone_compat import qtimezone_utc

if TYPE_CHECKING:
    from qtpy_filedialog.adapters.filesystem.pyfilesystemnode import PyFileSystemNode
