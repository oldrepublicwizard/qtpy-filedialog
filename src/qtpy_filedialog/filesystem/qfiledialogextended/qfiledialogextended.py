...
from qtpy_filedialog.adapters.filesystem.qfiledialog.qfiledialog import (
    QFileDialog as AdapterQFileDialog,
)
from qtpy_filedialog.common.actions_dispatcher import ActionsDispatcher
from qtpy_filedialog.common.ribbons_widget import RibbonsWidget
from qtpy_filedialog.common.tasks.actions_executor import FileActionsExecutor
from qtpy_filedialog.filesystem.qfiledialogextended.ui_qfiledialogextended import (
    Ui_QFileDialogExtended,
)
from qtpy_filedialog.widgets.itemviews.treeview import RobustTreeView
from qtpy_filedialog.widgets.widgets.stacked_view import DynamicStackedView
...
class QFileDialogExtended(AdapterQFileDialog):
    ...
    def _setup_item_delegate(self) -> None:
        ...
        try:
            ...
            from qtpy_filedialog.widgets.itemviews.file_size_delegate import (
    ...
    import logging
    def RobustLogger(*a, **k):
        return logging.getLogger('qtpy_filedialog')
    ...
    def _setup_address_bar(self) -> None:
        from qtpy_filedialog.common_filesystem.address_bar import RobustAddressBar
    ...
    def _setup_search_filter(self) -> None:
        ...
        try:
            from qtpy_filedialog.widgets.widgets.search_filter import (
    ...
    def _setup_preview_pane(self) -> None:
        ...
        try:
            from qtpy_filedialog.common_filesystem.enhanced_preview_pane import (
    ...
    def _set_extra_large_icons(self) -> None:
        ...
        from qtpy_filedialog.widgets.itemviews.thumbnail_list_view import IconSize
