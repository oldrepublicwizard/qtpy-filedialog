...
from qtpy_filedialog.common.tasks.task_status_widget import TaskStatusWidget
...
class Ui_QFileExplorer:
    ...
    def retranslateUi(self, QFileExplorer: FileSystemExplorerWidget | None = None):
        ...
        self.zoom_slider.setToolTip(_translate("QFileExplorer", "Adjust zoom level"))
        self.zoom_slider.setAccessibleName(_translate("QFileExplorer", "Zoom"))
